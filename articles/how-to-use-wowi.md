...
for spatial and spatio-temporal scan statistics. SaTScan’s **Bernoulli
...
>
> - “yes” – the number of cluster IDs is ≥ 5 and the number of children
>   with valid measurements is ≥ 100.
>
> - “no” – the above criteria are not met.
...
[`mwana`](https://nutriverse.io/mwana/dev/) package, which will be
installed or updated automatically when you install `wowi`. Moreover, in
the downstream analysis workflow, the `sf` package is required to
...
>
> We will now begin the walkthrough using the package’s built-in
> dataset, `anthro`.
...
> detection** — without them, spatial analysis simply cannot be
> performed.
...
[here](https://nutriverse.io/mwana/dev/articles/plausibility.html).
...
- 3:
  ...
  “/Applications/SaTScan.app/Contents/app”; for Windows, “C:/Program
  Files/SaTScan”.

- 4:

  Indicate the name of the SaTScan batch file. For macOS, use “satscan”;
  for Windows, use “SaTScanBatch64”.

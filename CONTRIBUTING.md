...
- Submit an issue on the [issues
  page](https://github.com/tiwowi/wowi/issues)
...
- Make sure to track progress upstream i.e., on our version of `wowi` at
  `tiwowi/wowi`, by doing

&nbsp;

    git remote add upstream https://github.com/tiwowi/wowi.git
...
- Submit a pull request at `tiwowi/wowi`

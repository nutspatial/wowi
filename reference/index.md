...
- [`wowi`](https://nutspatial.github.io/wowi/reference/wowi-package.md)
  [`wowi-package`](https://nutspatial.github.io/wowi/reference/wowi-package.md)
...
- [`ww_run_satscan()`](https://nutspatial.github.io/wowi/reference/ww_run_satscan.md)
  : Run SaTScan for Bernoulli purely spatial scan to detect
  statistically significant clusters of acute malnutrition
- [`ww_run_app()`](https://nutspatial.github.io/wowi/reference/ww_run_app.md)
...
- [`anthro`](https://nutspatial.github.io/wowi/reference/anthro.md) :
  Sample data set of district-level SMART surveys with geographical
  coordinates
